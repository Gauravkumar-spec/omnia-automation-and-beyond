...
✔ Added new service section, Calendarly, Contact form, redesigned layout flow
✔ Implemented motion effects using Framer Motion & Gsap Animation
✔ Improved performance: image compression, lazy loading, meta optimization  
✔ Collaborated directly with founders & marketing heads to align branding & messaging  
